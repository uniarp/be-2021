...
router.get('/', async (req, res) => {
    try {
        const query = await pool.query(`SELECT ec.*, s.numerosala, s.nomesala, p.nomecompleto FROM entregachave ec
            INNER JOIN reservasala rs ON ec.id_reservasala = rs.id
