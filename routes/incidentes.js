...
router.post('/cadastrar', async (req, res) => {
    try {
        ...
        await pool.query(`insert into incidente (descricao, tempoabertura, status, tempofechamento, resolucao, id_sala, id_professor)
            values($1,$2,$3,$4,$5,$6,$7)
            RETURNING *`, [data.descricao, data.tempoAbertura, data.status, data.tempoFechamento, data.resolucao, data.id_sala, data.id_professor]
        );
        res.status(200).send({
